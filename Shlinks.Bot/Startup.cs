...
// using Iciclecreek.AdaptiveExpressions;
...
// using IsNullOrEmpty = Shlinks.Bot.Functions.IsNullOrEmpty;
...
namespace Shlinks.Bot
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // AdaptiveExpressions.Expression.Functions.Add(IsValidUrl.Kind, new IsValidUrl());
            // AdaptiveExpressions.Expression.Functions.Add(IsNullOrEmpty.Kind, new IsNullOrEmpty());
            // JavascriptFunctions.AddFunctionsForScript(
            //     "strings",
            //     System.IO.File.ReadAllText("./functions/strings.js")
            // );
        }
