/*
 * ShlinksInputAction.cs
 *     Created: 2024-05-16T15:47:48-04:00
 *    Modified: 2024-05-16T15:47:49-04:00
...
public abstract class ShlinksInputAction<TAction>(
    string kind,
    IServiceProvider services,
    ILoggerFactory loggerFactory,
    [CallerFilePath] string sourceFilePath = "",
    [CallerLineNumber] int sourceLineNumber = 0
) : BotCustomInputAction<TAction>(kind, sourceFilePath, sourceLineNumber), ILog
    where TAction : ShlinksInputAction<TAction>
{
